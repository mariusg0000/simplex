...
3. Typography: Use clean sans-serif fonts with extended glyph sets. For DOCX/XLSX, use only fonts bundled with Microsoft Office (Calibri, Arial, Times New Roman, Aptos). For PDF/HTML, web fonts (Roboto, Open Sans) are acceptable. Default body text to 11pt-12pt. Create visual hierarchy for headings (H1, H2, H3) using only font weight and gradual size increases. Avoid excessive italics/underlines.
