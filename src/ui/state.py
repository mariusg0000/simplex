...
def get_system_prompt() -> dict:
    ...
    content += (
        ...
        "Do NOT read files just to pass their content to a sub-agent — write them to the shared folder instead.\n"
        "6. TRUST SUB-AGENT VERIFICATION: Sub-agents verify their own output before reporting success. "
        "Do NOT re-read or re-verify a file the sub-agent reports as successful. "
        "Only inspect the file if the user explicitly asks you to, or if the sub-agent reports an error. "
